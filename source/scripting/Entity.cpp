...
namespace GTA
{
	...
	Math::Vector3 Entity::RotationVelocity::get()
	{
		return Native::Function::Call<Math::Vector3>(Native::Hash::GET_ENTITY_ROTATION_VELOCITY, Handle);
	}
	void Entity::RotationVelocity::set(Math::Vector3 value)
	{
		return;
	}
